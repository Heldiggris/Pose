...
class PyramidPoseModel():
    def __init__(self, num_keypoints: int):
        ...
        #  In: 1, 64, 64, 48)
        self.conv12a = Block(block_num=4, channel=96, name_prefix="regression_conv12a_")    # input res: 64
        ...
        self.conv13a = Block(block_num=5, channel=192, name_prefix="regression_conv13a_")   # input res: 32
        ...
        self.conv14a = Block(block_num=6, channel=288, name_prefix="regression_conv14a_")   # input res: 16
